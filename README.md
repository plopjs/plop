...
| [**load**](https://github.com/plopjs/plop/blob/master/plop-load.md) | _Array[String], Object, Object_                            |                                                 | loads generators, helpers and/or partials from another plopfile or npm module |
...
Install `ts-node` module in to your project as dev dependency. Create plopfile.ts (you can find it in the [examples](example/typescript/plopfile.ts) github directory). Make sure your `tsconfig.json` compilerOptions includes required settings
